...
storiesOf('Card', module)
  ...
  .add('default', () => (
    <Card>
      What is a Product Designer? An awesome story by <Link href="src/Card/story#">@jgadapee</Link> over on
      Medium! <Link href="src/Card/story#">http://buff.ly/1LTbUqv</Link>
    </Card>
  ))
  .add('doublePadding', () => (
    <Card doublePadding>
